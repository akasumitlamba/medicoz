        ...
        NavigationStack(path: $path){
            ZStack {
                ...
                VStack {
                    ...
                    if isLoginMode {
                        NavigationLink(destination: patientHome(), isActive: $sessionManager.isLoggedIn) {
                            EmptyView()
                        }
                    } else {
                        NavigationLink(destination: patientAccountSetup(), isActive: $sessionManager.isLoggedIn) {
                            EmptyView()
                        }
                    }
...
struct patientAuth_Previews: PreviewProvider {
